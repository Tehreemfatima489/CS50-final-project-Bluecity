...
PlayerJumperState = Class{__includes = BaseState}

function PlayerJumperState:init(player, gravity)
    self.player = player
...
function PlayerJumperState:enter(params)
    gSounds['jump']:play()
    self.player.dy = jumper_value
end

function PlayerJumperState:update(dt)
